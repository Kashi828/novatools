...
const TASKS: Record<string, { title: string; prompt: string; placeholder: string }> = {
  ...
  'ai-translator': { title: 'Translate text', prompt: 'Translate the user-provided text. Preserve meaning, tone, formatting, names, and numbers. Ask for a target language if one is not supplied.', placeholder: 'Paste text and include the target language...' },
